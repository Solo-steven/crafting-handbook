...
const VisitorTable: Visitor = {
  ...
  [SyntaxKinds.ClassAccessorProperty]: transformKind,
  ...
  [SyntaxKinds.Decorator]: transformKind,
  ...
  [SyntaxKinds.TSCallSignatureDeclaration]: transformKind,
  [SyntaxKinds.TSConstructSignatureDeclaration]: transformKind,
  [SyntaxKinds.TSPropertySignature]: transformKind,
  [SyntaxKinds.TSMethodSignature]: transformKind,
  [SyntaxKinds.TSQualifiedName]: transformKind,
  [SyntaxKinds.TSTypePredicate]: transformKind,
  [SyntaxKinds.TSTypeAnnotation]: transformKind,
  [SyntaxKinds.TSTypeReference]: transformKind,
  [SyntaxKinds.TSStringKeyword]: transformKind,
  [SyntaxKinds.TSNumberKeyword]: transformKind,
  [SyntaxKinds.TSBigIntKeyword]: transformKind,
  [SyntaxKinds.TSBooleanKeyword]: transformKind,
  [SyntaxKinds.TSNullKeyword]: transformKind,
  [SyntaxKinds.TSUndefinedKeyword]: transformKind,
  [SyntaxKinds.TSSymbolKeyword]: transformKind,
