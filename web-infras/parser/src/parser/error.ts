export const ErrorMessageMap = {
  ...
  setter_can_not_have_rest_element_as_argument:
    "setter method can not ahve rest element as argument",
  setter_and_getter_can_not_used_in_field_definition:
    "setter and getter can not used in field definition",
  constructor_can_not_be_async_or_generator:
    "constructor in class can not be a async or generator",
  object_property_can_not_have_initializer: "object property can not have initializer",
  private_field_can_not_use_in_object:
    "Private field '#test' must be declared in an enclosing class",
  ...
  invalid_rest_element_with_pattern_in_object_pattern:
    "invalid rest element with pattern in object pattern",
  // binding pattern, assignment pattern
  destructing_pattern_must_need_initializer:
    "destucturing pattern must have a initializer",
  invalid_left_value: "invalid left value",
  assigment_pattern_only_can_use_assigment_operator:
    "assigment pattern can only using assignment operator",
  ...
  sequence_expression_can_not_have_trailing_comma:
  ...
  illegal_use_strict_in_non_simple_parameter_list:
    "illegal use strict in non simple parameter list",
  ...
  tag_template_expression_can_not_use_option_chain:
    "Tag template expression should not using optional chain",
  ...
  await_can_not_call_if_not_in_async:
    "await expression can not be call if not in async block",
  ...
  await_expression_can_not_used_in_parameter_list:
    "await expression can not used in parameter list",
  yield_expression_can_not_used_in_parameter_list:
