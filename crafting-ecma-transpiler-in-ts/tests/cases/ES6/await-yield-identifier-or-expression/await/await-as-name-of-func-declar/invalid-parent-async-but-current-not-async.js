...
// - when parent not async, current is async  -> await can be name of function declar
// - when parent is async, current not async  -> await can not be name of function declar (this test case)
