...
pub struct ErrorMap {
    // general
    pub unexpect_token: &'static str,
    pub missing_semicolon: &'static str,
    // class, object property, method .. etc
    pub getter_should_never_has_params: &'static str,
    pub getter_can_not_be_async_or_generator: &'static str,
    pub setter_should_has_only_one_params: &'static str,
    pub setter_can_not_be_async_or_generator: &'static str,
    pub setter_can_not_have_rest_element_as_argument: &'static str,
    pub setter_and_getter_can_not_used_in_field_definition: &'static str,
    pub constructor_can_not_be_async_or_generator: &'static str,
    pub object_property_can_not_have_initializer: &'static str,
    pub private_field_can_not_use_in_object: &'static str,
    pub invalid_property_name: &'static str,
    pub no_changle_line_after_async: &'static str,
    pub super_can_not_call_if_not_in_class: &'static str,
    pub super_must_be_followed_by_an_argument_list_or_member_access: &'static str,
    // spread, rest element
    pub rest_element_should_be_last_property: &'static str,
    pub rest_element_can_not_end_with_comma: &'static str,
    pub rest_element_can_not_use_in_cover: &'static str,
    pub rest_element_must_be_either_binding_identifier_or_binding_pattern: &'static str,
    pub invalid_rest_element_with_pattern_in_object_pattern: &'static str,
    // binding pattern, assignment pattern
    pub destructing_pattern_must_need_initializer: &'static str,
    pub invalid_left_value: &'static str,
    pub assigment_pattern_only_can_use_assigment_operator: &'static str,
    pub assignment_pattern_left_value_can_only_be_idenifier_or_pattern: &'static str,
    pub binding_pattern_can_not_have_member_expression: &'static str,
    // for-related statement
    pub for_in_of_loop_can_not_using_initializer: &'static str,
    pub for_in_of_loop_can_not_have_one_more_binding: &'static str,
    pub await_can_just_in_for_of_loop: &'static str,
    // trailing comma
    pub function_parameter_can_not_have_empty_trailing_comma: &'static str,
    pub sequence_expression_can_not_have_trailing_comma: &'static str,
    pub function_argument_can_not_have_empty_trailing_comma: &'static str,
    // strict mode problem
    pub unexpect_keyword_in_stric_mode: &'static str,
    pub illegal_use_strict_in_non_simple_parameter_list: &'static str,
    // invalid change line char
    pub no_line_break_is_allowed_before_arrow: &'static str,
    pub no_line_break_is_allowed_before_async: &'static str,
    // nullish and expont operator
    pub nullish_require_parans: &'static str,
    pub expont_operator_need_parans: &'static str,
    // other
    pub new_expression_cant_using_optional_chain: &'static str,
    pub tag_template_expression_can_not_use_option_chain:  &'static str,
    pub keyword_can_not_use_in_imported_when_just_a_specifier: &'static str,
    pub duplicate_param: &'static str,
    pub await_can_not_call_if_not_in_async: &'static str,
    pub import_meta_invalid_property: &'static str,
    pub when_in_async_context_await_keyword_will_treat_as_keyword: &'static str,
    pub when_in_yield_context_yield_will_be_treated_as_keyword: &'static str,
    pub yield_deletgate_can_must_be_followed_by_assignment_expression: &'static str,
    pub await_expression_can_not_used_in_parameter_list: &'static str,
    pub yield_expression_can_not_used_in_parameter_list: &'static str,
    pub new_target_can_only_be_used_in_class_or_function_scope: &'static str,
    pub lable_statement_can_not_have_function_declaration_is_generator: &'static str,
    pub let_keyword_can_not_use_as_identifier_in_lexical_binding: &'static str,
    pub import_call_is_not_allow_as_new_expression_called: &'static str,
}
