...
fn run_simple_loop_with_register() {
    ...
    let instructions = vec![
        // Lable 1: init
        /* 0 */
        Instruction::Addi(AddImmiInstruction {
            src: 1,
            dst: 1,
            value: 0,
        }),
        // Label 2: condition
        /* 1 */
        Instruction::Lti(LessThanImmiInstruction { src: 1, value: 10 }),
        /* 2 */
        Instruction::Br(BranchInstruction {
            address: 4,
            condition: 0,
        }),
...
fn run_simple_loop_with_memory() {
    ...
    let instructions = vec![
        ...
        /* 1 */
        Instruction::Str(StoreRegisterInstruction {
            base: 14,
            offset: 0,
            src: 0,
        }),
        ...
        // Label_init:
        /* 3 */
        Instruction::Immi(ImmiInstruction { value: 0, dst: 0 }),
        /* 4 */
        Instruction::Str(StoreRegisterInstruction {
            base: 14,
            offset: 0,
        ...
        // // Label_cond:
        /* 6 */
        Instruction::Ldr(LoadRegisterInstruction {
            base: 15,
            offset: 1,
            dst: 0,
        }),
        ...
        /* 17 */
        Instruction::Jump(JumpInstruction { address: 6 }),
        // Label_finish
        /* 18 */
    ];
    virtual_machine.execute_with_instruction(instructions, 0);
...
fn run_simple_func_call() {
    ...
    let instructions = vec![
        //  _test_fun
        /* 0 */
        Instruction::Immi(ImmiInstruction { dst: 0, value: 0 }),
        /* 1 */
        Instruction::Str(StoreRegisterInstruction {
            base: 14,
            offset: 0,
        ...
        // Label_finish
        /* 18 */
        Instruction::Subi(SubiInstruction {
            src: 14,
            dst: 14,
            value: 2,
        }),
...
fn run_fib_recursion() {
    ...
    let instructions = vec![
        ...
        // _f_base_case:
        /* 5 */
        Instruction::Immi(ImmiInstruction { dst: 12, value: 1 }),
        ...
        /* 156 */
        Instruction::Immi(ImmiInstruction { dst: 9, value: 2 }),
        // function call
