...
impl Function {
    ...
    pub fn add_register(&mut self, value_type: IrValueType) -> Value {
        ...
        self.values.insert(
            value_id,
            ValueData::VirRegister(format!("t{}", self.next_temp_register_index)),
        );
    ...
    fn check_value_pair_type_equal(
        ...
        if type1 == IrValueType::Address || type2 == IrValueType::Address {
            ...
            panic!(
                "instruction on two type value is not equal {}({:?}), {}({:?})",
                src1.0, type1, src2.0, type2
            );
        }
    }
    #[inline]
    ...
    fn make_binary_inst(&mut self, opecode: OpCode, left: Value, right: Value) -> Value {
        ...
        let inst = match opecode {
            OpCode::Add => InstructionData::Add {
                opcode: OpCode::Add,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::Sub => InstructionData::Sub {
                opcode: OpCode::Sub,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::Divide => InstructionData::Divide {
                opcode: OpCode::Mul,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::Mul => InstructionData::Mul {
                opcode: OpCode::Mul,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::Reminder => InstructionData::Reminder {
                opcode: OpCode::Reminder,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::FAdd => InstructionData::Add {
                opcode: OpCode::FAdd,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::FSub => InstructionData::Sub {
                opcode: OpCode::FSub,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::FDivide => InstructionData::Divide {
                opcode: OpCode::FDivide,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::FMul => InstructionData::Mul {
                opcode: OpCode::FMul,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::FReminder => InstructionData::Reminder {
                opcode: OpCode::Reminder,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::BitwiseAnd => InstructionData::BitwiseAnd {
                opcode: OpCode::BitwiseAnd,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::BitwiseOR => InstructionData::BitwiseOR {
                opcode: OpCode::BitwiseOR,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::ShiftLeft => InstructionData::ShiftLeft {
                opcode: OpCode::ShiftLeft,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::ShiftRight => InstructionData::ShiftRight {
                opcode: OpCode::ShiftRight,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::LogicalAnd => InstructionData::LogicalAnd {
                opcode: OpCode::LogicalAnd,
                src1: left,
                src2: right,
                dst,
            },
            OpCode::LogicalOR => InstructionData::LogicalOR {
    ...
    fn make_unary_inst(&mut self, opecode: OpCode, src: Value) -> Value {
        ...
        let inst = match opecode {
            OpCode::Neg => InstructionData::Neg {
                opcode: OpCode::Neg,
                src,
                dst,
            },
            OpCode::LogicalNot => InstructionData::BitwiseNot {
                opcode: OpCode::BitwiseNot,
                src,
                dst,
            },
            OpCode::BitwiseNot => InstructionData::LogicalNot {
                opcode: OpCode::LogicalNot,
                src,
                dst,
            },
            _ => unreachable!(),
    ...
    fn make_convert_inst(&mut self, opcode: OpCode, src: Value) -> Value {
        ...
        let inst = match opcode {
            OpCode::ToU8 => InstructionData::ToU8 {
                opcode: OpCode::ToU8,
                src,
                dst,
            },
            OpCode::ToU16 => InstructionData::ToU16 {
                opcode: OpCode::ToU16,
                src,
                dst,
            },
            OpCode::ToU32 => InstructionData::ToU32 {
                opcode: OpCode::ToU32,
                src,
                dst,
            },
            OpCode::ToU64 => InstructionData::ToU64 {
                opcode: OpCode::ToU64,
                src,
                dst,
            },
            OpCode::ToI16 => InstructionData::ToI16 {
                opcode: OpCode::ToI16,
                src,
                dst,
            },
            OpCode::ToI32 => InstructionData::ToI32 {
                opcode: OpCode::ToI32,
                src,
                dst,
            },
            OpCode::ToI64 => InstructionData::ToI64 {
                opcode: OpCode::ToI64,
                src,
                dst,
            },
            OpCode::ToF32 => InstructionData::ToF32 {
                opcode: OpCode::ToF32,
                src,
                dst,
            },
            OpCode::ToF64 => InstructionData::ToF64 {
                opcode: OpCode::ToF64,
                src,
                dst,
            },
            OpCode::ToAddress => InstructionData::ToAddress {
    ...
    pub fn get_value_ir_type(&self, src: Value) -> IrValueType {
        match self.values.get(&src) {
            Some(node) => match node {
                ValueData::Immi(immi) => match immi {
                ...
                _ => self.value_types.get(&src).unwrap().clone(),
            },
            None => {
                unreachable!()
            }
    ...
    pub fn build_comment(&mut self, comment: &str) {
        let inst_id = self.get_next_inst_id();
        self.instructions
            .insert(inst_id, InstructionData::Comment(String::from(comment)));
        self.add_inst_id_to_current_block(inst_id);
    }
}
