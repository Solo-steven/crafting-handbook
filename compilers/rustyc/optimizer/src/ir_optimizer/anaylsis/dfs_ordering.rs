...
impl DFSOrdering {
    ...
    /// Get order of CFG blocks, return a vec. frist element of vec 
    /// is the frist block of cfg
    ...
    pub fn get_order_with_map(&mut self, entry_id: BasicBlock,  blocks: &BasicBlockMap) -> (Vec<BasicBlock>, HashMap<BasicBlock, usize>) {
